...
<head>
    ...
    <title>Bulid company-МЖК Інжиніринг</title>
        ...
        <section class="home">
            <div class="container">
                <div class="home-content">
                    ...
                    <div class="home-btn">
                        <a href="cooperation.php?page=cooperation"><button class="btn">Замовити проект</button></a>
                        <a href="/index.html#about_us"><button class="btn look">Детальніше</button></a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="our-project">
            <div class="container-fluid">
                ...
                <div class="our-projects">
                    ...
                    <a href="projects.html"><button class="button-6" role="button">Більше</button></a>
                </div>
        </section>
