        ...
        <section class="home">
            <div class="container">
                <div class="home-content">
                    <div class="home-text">
                        <p>{{$obj->about_project["name_header"]}}</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="main-info">
                    <div class="info-block">
                        <div class="info-heading">
                            ...
                            <div class="heading-text">{{$obj->about_project["name_project"]}}</div>
                        </div>
                        <div class="info">
                            <i class="line"><img src={{asset('images/line_info.png')}} , alt="line"/></i>
                            <div class="info-text">{{$obj->about_project["info_about"]}}
                            </div>
                        </div>
                        <a href="#">
                        ...
                        <div class="order">
                            ...
                            <div class="order-text">Замовник: {{$obj->about_project["order"]}}</div>
                        </div>
                    </div>
                    <div class="info-img">
                        <img src={{$obj->about_project["img_project"]}} , alt="manheten-build"/>
                        <div class="img-describe">
                            <i class="adress"><img src={{asset('/images/nav.svg')}} , alt="adress"/></i>
                            <div class="img-text">{{$obj->about_project["adress"]}}
                            </div>
                        </div>
                    </div>
                </div>
